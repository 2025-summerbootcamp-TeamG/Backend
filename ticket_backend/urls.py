...
from tickets.views import FaceRegisterAPIView, TicketFaceAuthAPIView, face_register_page
...
from tickets.views import AWSFaceRecognitionRegister, AWSFaceRecognitionAuth
